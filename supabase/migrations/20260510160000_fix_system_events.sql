...
BEGIN
    ...
    INSERT INTO public.system_events (event_name, event_date, event_type)
    VALUES (p_event_name, p_event_date, p_event_type);
...
CREATE POLICY "Super Admins can select system events" 
ON system_events
FOR SELECT
TO authenticated
